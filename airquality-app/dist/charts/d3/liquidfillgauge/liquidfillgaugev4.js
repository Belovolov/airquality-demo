...
function liquidFillGaugeDefaultSettings(){
    return {
        ...
        circleFillGap: 0.09, // The size of the gap between the outer circle and wave circle as a percentage of the outer circles radius.
        ...
        titleVertPosition: .5, // The height at which to display the percentage text withing the wave circle. 0 = bottom, 1 = top.
        textSize: 12, // The relative height of the text to display in the wave circle. 1 = 50%
        titleSize: 6, // The relative height of the text to display in the wave circle. 1 = 50%
...
function loadLiquidFillGauge(elementId,title, value, config) {
    ...
    var textPixels = (config.textSize*radius/16);
    var titlePixels = (config.titleSize*radius/16);
  ...
  console.log(elementId + "finalshow this textcontent2: " + this.textContent );
                 }
            };
